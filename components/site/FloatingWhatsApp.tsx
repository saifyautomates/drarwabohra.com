...
import { waLink } from "@/lib/data-client";

/**
 * Floating WhatsApp chat button. Sits above the mobile booking bar on
 * small screens (bottom-24) and in the corner on desktop.
 */
export default function FloatingWhatsApp({ whatsapp }: { whatsapp: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-emerald text-white shadow-lift transition-transform hover:scale-105 active:scale-95 md:bottom-6 md:right-6"
    >
      <svg
        width="28"
        height="28"
